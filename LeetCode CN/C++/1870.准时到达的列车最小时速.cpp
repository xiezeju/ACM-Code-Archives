 ...
 * - 由于是在整数时间到达，可以立即换乘在第 1 小时发车的列车。第 2
 * 趟列车运行需要 3/1 = 3 小时。
 * - 由于是在整数时间到达，可以立即换乘在第 4 小时发车的列车。第 3
 * 趟列车运行需要 2/1 = 2 小时。
 * - 你将会恰好在第 6 小时到达。
 *
 *
 ...
 * - 由于不是在整数时间到达，故需要等待至第 1 小时才能搭乘列车。第 2
 * 趟列车运行需要 3/3 = 1 小时。
 * - 由于是在整数时间到达，可以立即换乘在第 2 小时发车的列车。第 3
 * 趟列车运行需要 2/3 = 0.66667 小时。
 * - 你将会在第 2.66667 小时到达。
 *
 * 示例 3：
 *
