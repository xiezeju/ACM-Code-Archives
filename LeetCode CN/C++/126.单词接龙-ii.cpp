...
class Solution {
    public:
        vector<vector<string>> findLadders(string beginWord, string endWord,
            ...
            // 因为需要快速判断扩展出的单词是否在 wordList 里，因此需要将
            // wordList 存入哈希表，这里命名为「字典」
            ...
            // 第 2 步：回溯找到所有解，从 endWord 恢复到 beginWord
            // ，所以每次尝试操作 path 列表的头部
            if (found) {
        ...
        void backtrack(vector<vector<string>>& res, const string& Node,
