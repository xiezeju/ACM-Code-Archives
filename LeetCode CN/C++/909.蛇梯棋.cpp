 ...
 *
 *
 * 该选择模拟了掷 六面体骰子 的情景，无论棋盘大小如何，玩家最多只能有 6
 * 个目的地。
 *
 *
 * 传送玩家：如果目标方格 next
 * 处存在蛇或梯子，那么玩家会传送到蛇或梯子的目的地。否则，玩家传送到目标方格
 * next 。  当玩家到达编号 n^2 的方格时，游戏结束。
 *
 *
 * r 行 c 列的棋盘，按前述方法编号，棋盘格中可能存在 “蛇” 或 “梯子”；如果
 * board[r][c] != -1，那个蛇或梯子的目的地将会是 board[r][c]。编号为 1 和 n^2
 * 的方格上没有蛇或梯子。
 *
