...
SELECT query_name,ROUND(SUM(rating/position)/COUNT(query_name),2) AS quality,ROUND(COUNT((SELECT query_name WHERE rating<3))*100/COUNT(query_name),2) AS poor_query_percentage
FROM Queries
GROUP BY query_name
-- @lc code=end
