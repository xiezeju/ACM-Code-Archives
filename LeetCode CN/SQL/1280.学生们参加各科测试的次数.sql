...
SELECT Students.student_id,Students.student_name,Subjects.subject_name,IFNULL(ex.attended_exams,0) AS attended_exams
...
ON Students.student_id = ex.student_id AND Subjects.subject_name = ex.subject_name
